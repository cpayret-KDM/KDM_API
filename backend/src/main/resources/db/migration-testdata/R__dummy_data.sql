...
BEGIN
	...
	INSERT INTO "public"."Address" ("street1", "street2", "city", "state", "zip")
	...
	SELECT 1000000, 'Codingscape-BackEnd', 'Diego', 'Bolanos', '+506 8817-6566', 'diego@codingscape.com', 'UT'
	WHERE 
		NOT EXISTS (
	...
	INSERT INTO "public"."Sponsor" ("addressId", "Company", "firstName", "lastName", "phone", "email", "registrationState")
	SELECT 1000001, 'Codingscape-FrontEnd', 'Jen', 'Wilhelm', '+1 555 777-7777', 'jen@codingscape.com', 'AK'
	WHERE 
		NOT EXISTS (
	...
	INSERT INTO "public"."Sponsor" ("addressId", "Company", "firstName", "lastName", "phone", "email", "registrationState") 
	SELECT 1000002, 'Codingscape-Manager', 'Jimmy', 'Jacobson', '+1 555 777-8888', 'jimmy@codingscape.com', 'HI'
	WHERE 
		NOT EXISTS (
	...
	INSERT INTO "public"."Sponsor" ("addressId", "Company", "firstName", "lastName", "phone", "email", "registrationState") 
	SELECT 1000000, 'Codingscape-FullStack', 'Rich', 'Hoppes', '+1 555 777-9999', 'rich@codingscape.com', 'FL'
	WHERE 
		NOT EXISTS (
	...
	WHERE
		NOT EXISTS (
			SELECT "ticker" FROM "public"."CUSIP" WHERE "ticker" = '50067AAC6'
		);
	...
	WHERE
		NOT EXISTS (
			SELECT "ticker" FROM "public"."CUSIP" WHERE "ticker" = '50067AAD4'
		);
		
	INSERT INTO "public"."MSN" ("cusipID", "number", "tradeDate", "maturityDate", "noteRate")
	SELECT 1000000, 'KDM2017-N001', NULL, '2017-05-01 00:00:00', 5.00
	WHERE
		NOT EXISTS (
	...
	INSERT INTO "public"."MSN" ("cusipID", "number", "tradeDate", "maturityDate", "noteRate")
	SELECT 1000001, 'KDM2017-N002', NULL, '2020-12-21 00:00:01', 6.00
	WHERE
		NOT EXISTS (
	...
	SELECT 1000000, 1000000, 'KDM2017-L001', NULL, NULL, '2027-05-01 00:00:01', NULL, 'PERFORMING', 1059000.00, 'CLOSED', 53.70, NULL, 5.25
	WHERE
		NOT EXISTS (
	...
	SELECT 1000000, 1000000, 1000000, 'MULTI_FAMILY'
	WHERE
		NOT EXISTS (
	...
	INSERT INTO "public"."Property" ("addressID", "loanID", "borrowerID", "type")
	SELECT 1000001, 1000000, 1000001, 'MULTI_FAMILY'
	WHERE
		NOT EXISTS (
	...
	INSERT INTO "public"."Property" ("addressID", "loanID", "borrowerID", "type")
	SELECT 1000002, 1000001, 1000002, 'MULTI_FAMILY'
	WHERE
		NOT EXISTS (
	...
	SELECT 1000000, 960000.00, '2020-10-27 13:34:30'
	WHERE
		NOT EXISTS (
	...
	INSERT INTO "public"."Appraisal" ("propertyID", "value", "date")
	SELECT 1000001, 960000.00, '2020-10-27 13:35:03'
	WHERE
		NOT EXISTS (
	...
	INSERT INTO "public"."Appraisal" ("propertyID", "value", "date")
	SELECT 1000002, 1605000.00, '2020-10-27 13:56:37'
	WHERE
		NOT EXISTS (
