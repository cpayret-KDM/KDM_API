...
export const GET_CASH_FLOW_LOANS = 'GET_CASH_FLOW_LOANS';
export const GET_CASH_FLOW_LOANS_SUCCESS = 'GET_CASH_FLOW_LOANS_SUCCESS';
export const GET_CASH_FLOW_LOANS_FAILURE = 'GET_CASH_FLOW_LOANS_FAILURE';
...
export const EDIT_LOAN_RATINGS = 'EDIT_LOAN_RATINGS';
export const EDIT_LOAN_RATINGS_SUCCESS = 'EDIT_LOAN_RATINGS_SUCCESS';
export const EDIT_LOAN_RATINGS_FAILURE = 'EDIT_LOAN_RATINGS_FAILURE';
